#!/usr/bin/env python3
"""
fetch_apis.py — Fetches HN AI stories + GitHub trending AI repos.
Zero external API cost. GitHub token is auto-provided by Actions.
"""
...
def main():
    ...
    with open(data_dir / "github_trending.json", "w") as f:
        json.dump(fetch_github(), f, indent=2)
